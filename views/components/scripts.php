 ...
 * Carga de módulos JavaScript base, enrutador SPA y escuchadores DOM comunes.
 * 
 * Parámetros esperados:
 * - $moduleScript (string): 'admin.js' o 'docente.js'
 */
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configuración interactiva del Sidebar (Colapso y Responsive)
    ...
    // Definición de Rutas SPA según módulo
