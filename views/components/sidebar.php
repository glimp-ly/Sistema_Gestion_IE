 ...
 * Menú de navegación lateral adaptable según el rol del usuario (Admin vs Docente).
 * 
 * Parámetros opcionales:
 * - $activeRole (string): 'admin' o 'docente' (por defecto infiere del rol de la sesión)
 */
